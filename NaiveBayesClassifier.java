...
public class NaiveBayesClassifier {
    ...
    private Map<String, Integer> wordCountA;//Schlüssel: Wort, Wert: Anzahl des Wortes in Klasse A
    private Map<String, Integer> wordCountB;//Schlüssel: Wort, Wert: Anzahl des Wortes in Klasse B
